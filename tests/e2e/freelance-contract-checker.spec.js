...
const SVC_URL = "https://appadaycreator.com/freelance-contract-checker/";
const SVC_NAME = "フリーランス契約書チェックリスト";

test.describe("フリーランス契約書チェックリスト - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("freelance-contract-checker");
